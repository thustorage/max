...
struct f2fs_checkpoint {
...
#ifdef MLOG
	__le32 nr_mlog; 
	__le32 cur_node_segno[MAX_ACTIVE_NODE_LOGS + MAX_EXTEND_LOGS * NR_CURSEG_NODE_TYPE]; // for Max
	__le16 cur_node_blkoff[MAX_ACTIVE_NODE_LOGS + MAX_EXTEND_LOGS * NR_CURSEG_NODE_TYPE]; // for Max
	/* information of current data segments */
	__le32 cur_data_segno[MAX_ACTIVE_DATA_LOGS + MAX_EXTEND_LOGS * NR_CURSEG_DATA_TYPE];
	__le16 cur_data_blkoff[MAX_ACTIVE_DATA_LOGS + MAX_EXTEND_LOGS * NR_CURSEG_DATA_TYPE];
#else
	/* information of current node segments */
	...
	unsigned char alloc_type[MAX_ACTIVE_LOGS + MAX_EXTEND_LOGS * NR_CURSEG_TYPE];
#else
	/* allocation type of current segment */
